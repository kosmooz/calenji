    ...
    <section className="pt-20 pb-24 md:pt-28 md:pb-32">
      <div className="container">
        <motion.div className="max-w-2xl mx-auto text-center mb-16" initial="hidden" animate="visible" variants={fadeUp}>
          ...
          <motion.h1 variants={fadeUp} custom={1} className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-5">Parlons de votre projet.</motion.h1>
          <motion.p variants={fadeUp} custom={2} className="text-lg text-gray-500">Une question, une suggestion ou un besoin spécifique ? Nous sommes là pour vous aider.</motion.p>
        </motion.div>
