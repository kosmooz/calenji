          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="text-[15px] text-gray-600 leading-relaxed mb-5">&ldquo;{t.text}&rdquo;</p>
                <div>
      ...
      <section className="py-24 md:py-32">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="rounded-xl border border-gray-200 p-7 bg-white">
              ...
              <div className="mb-6"><span className="text-4xl font-extrabold text-gray-900">0€</span><span className="text-[14px] text-gray-400 ml-1">/mois</span></div>
              <ul className="space-y-2.5 mb-7">
                {["3 comptes sociaux", "30 publications/mois", "Calendrier visuel", "Prévisualisation"].map((f) => (
                  <li key={f} className="flex items-center gap-2.5 text-[14px] text-gray-600"><Check size={15} className="text-gray-400" /> {f}</li>
                ))}
              </ul>
              <Link href="/contact" className="block text-center py-2.5 rounded-lg border border-gray-200 text-[14px] font-medium text-gray-700 hover:bg-gray-50 transition-colors">Commencer</Link>
            </motion.div>

            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1} className="rounded-xl border-2 border-gray-900 p-7 bg-white relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-[11px] font-medium px-3 py-1 rounded-full">Populaire</div>
              ...
              <div className="mb-6"><span className="text-4xl font-extrabold text-gray-900">15€</span><span className="text-[14px] text-gray-400 ml-1">/mois</span></div>
              <ul className="space-y-2.5 mb-7">
                {["10 comptes sociaux", "Publications illimitées", "Analyses avancées", "IA intégrée", "Support prioritaire"].map((f) => (
                  <li key={f} className="flex items-center gap-2.5 text-[14px] text-gray-600"><Check size={15} className="text-gray-900" /> {f}</li>
                ))}
              </ul>
              <Link href="/contact" className="block text-center py-2.5 rounded-lg bg-gray-900 text-white text-[14px] font-medium hover:bg-gray-800 transition-colors">Commencer</Link>
            </motion.div>

            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={2} className="rounded-xl border border-gray-200 p-7 bg-white">
              ...
              <div className="mb-6"><span className="text-4xl font-extrabold text-gray-900">49€</span><span className="text-[14px] text-gray-400 ml-1">/mois</span></div>
              <ul className="space-y-2.5 mb-7">
                {["Comptes illimités", "Publications illimitées", "Collaboration d'équipe", "Rapports clients", "API & webhooks", "Support dédié"].map((f) => (
                  <li key={f} className="flex items-center gap-2.5 text-[14px] text-gray-600"><Check size={15} className="text-gray-400" /> {f}</li>
                ))}
              </ul>
              <Link href="/contact" className="block text-center py-2.5 rounded-lg border border-gray-200 text-[14px] font-medium text-gray-700 hover:bg-gray-50 transition-colors">Contacter les ventes</Link>
            </motion.div>
          </div>

          <div className="text-center mt-8">
            <Link href="/prix" className="text-[14px] text-gray-500 hover:text-gray-900 transition-colors underline underline-offset-4">Voir tous les détails des plans</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-gray-900">
        <div className="container">
          <motion.div className="max-w-2xl mx-auto text-center" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-5">Prêt à simplifier vos réseaux sociaux ?</h2>
            <p className="text-lg text-gray-400 mb-8">Rejoignez des milliers de créateurs et d&apos;équipes qui utilisent Calenji pour gagner du temps et publier mieux.</p>
            ...
            <p className="text-[13px] text-gray-500 mt-4">Gratuit pour toujours. Aucune carte de crédit requise.</p>
          </motion.div>
        </div>
      </section>
    </>
