    ...
    <>
      <section className="pt-20 pb-16 md:pt-28 md:pb-24">
        <div className="container">
          <motion.div className="max-w-3xl mx-auto text-center" initial="hidden" animate="visible" variants={fadeUp}>
            <motion.p variants={fadeUp} custom={0} className="text-[13px] font-medium text-gray-400 uppercase tracking-wider mb-3">Fonctionnalités</motion.p>
            <motion.h1 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-extrabold text-gray-900 tracking-tight mb-6">Tout ce dont vous avez besoin pour vos réseaux sociaux.</motion.h1>
            <motion.p variants={fadeUp} custom={2} className="text-lg md:text-xl text-gray-500 leading-relaxed max-w-xl mx-auto">Un seul outil pour planifier, publier, analyser et collaborer sur tous vos réseaux sociaux.</motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-5">Votre planning éditorial, visuellement.</h2>
              <p className="text-[16px] text-gray-500 leading-relaxed mb-6">Fini les tableurs et les post-its. Visualisez l&apos;ensemble de votre stratégie de contenu sur un calendrier intuitif. Chaque plateforme a sa couleur, chaque publication son statut.</p>
              <ul className="space-y-3">
                {["Vue mensuelle, hebdomadaire et quotidienne", "Code couleur par plateforme et par statut", "Drag & drop pour réorganiser les publications", "Filtres par compte, plateforme et type de contenu", "Vue d'ensemble multi-comptes pour les agences"].map((item) => (
                  <li key={item} className="flex items-start gap-3 text-[15px] text-gray-600"><Check size={18} className="text-gray-900 mt-0.5 shrink-0" /> {item}</li>
                ))}
              </ul>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6, ease }}>
              <WindowFrame title="Calendrier"><img src={IMAGES.dashboard} alt="Calendrier visuel Calenji" className="w-full" loading="lazy" /></WindowFrame>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6, ease }} className="order-2 md:order-1">
              <WindowFrame title="Éditeur"><img src={IMAGES.composer} alt="Éditeur de publication Calenji" className="w-full" loading="lazy" /></WindowFrame>
            </motion.div>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="order-1 md:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-5">Composez une fois, publiez partout.</h2>
              <p className="text-[16px] text-gray-500 leading-relaxed mb-6">Rédigez votre publication et adaptez-la pour chaque plateforme. Prévisualisez le rendu exact sur Instagram, LinkedIn, Twitter et tous les autres réseaux.</p>
              <ul className="space-y-3">
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-5">Des données, pas des suppositions.</h2>
              <p className="text-[16px] text-gray-500 leading-relaxed mb-6">Comprenez ce qui fonctionne et ce qui ne fonctionne pas. Suivez l&apos;engagement, la portée, les impressions et la croissance de chaque compte et chaque publication.</p>
              <ul className="space-y-3">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6, ease }}>
              <WindowFrame title="Analyses"><img src={IMAGES.analytics} alt="Analyses Calenji" className="w-full" loading="lazy" /></WindowFrame>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6, ease }} className="order-2 md:order-1">
              <WindowFrame title="Drag & Drop"><img src={IMAGES.dragDrop} alt="Drag and drop Calenji" className="w-full" loading="lazy" /></WindowFrame>
            </motion.div>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="order-1 md:order-2">
              <p className="text-[13px] font-medium text-gray-400 uppercase tracking-wider mb-3">Drag & Drop</p>
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-5">Réorganisez en un geste.</h2>
              <p className="text-[16px] text-gray-500 leading-relaxed mb-6">Besoin de décaler une publication ? Glissez-la simplement vers un autre jour ou un autre créneau. Pas de formulaire, pas de clic supplémentaire.</p>
              <ul className="space-y-3">
