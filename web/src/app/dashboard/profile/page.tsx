...
export default function ProfilePage() {
  ...
  const fields = [
    ...
    { label: "Prenom", value: user.firstName || "—" },
    { label: "Nom", value: user.lastName || "—" },
    { label: "Telephone", value: user.phone || "—" },
    { label: "Societe", value: user.company || "—" },
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            {user.emailVerified ? (
              <Badge variant="outline" className="text-green-600 border-green-200">Email verifie</Badge>
            ) : (
              <Badge variant="outline" className="text-orange-600 border-orange-200">Email non verifie</Badge>
            )}
          </div>
        </div>
      </CardHeader>
