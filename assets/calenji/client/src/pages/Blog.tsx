/*
 * Design: Notion/Tally style — minimal blog listing
 */
...
export default function Blog() {
  ...
  useEffect(() => {
    document.title = "Blog — Calenji | Conseils et Stratégies Réseaux Sociaux";
  }, []);
      ...
      <section className="pt-20 pb-12 md:pt-28 md:pb-16">
        <div className="container">
          <motion.div className="max-w-3xl mx-auto text-center" initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <motion.p variants={fadeUp} custom={2} className="text-lg text-gray-500 max-w-xl mx-auto">
              Conseils pratiques, stratégies et guides pour optimiser votre présence sur les réseaux sociaux.
            </motion.p>
          </motion.div>
        </div>
      </section>
              ...
              <Link href={`/blog/${featured.slug}`} className="block group">
                <div className="grid md:grid-cols-2 gap-0 items-stretch rounded-xl border border-gray-100 overflow-hidden hover:border-gray-200 transition-colors">
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight mb-4 group-hover:text-gray-600 transition-colors leading-snug">
                      {featured.title}
                    </h2>
                  ...
                  <Link href={`/blog/${article.slug}`} className="block group h-full">
                    <div className="h-full rounded-xl border border-gray-100 overflow-hidden hover:border-gray-200 transition-colors flex flex-col">
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <h3 className="text-[15px] font-semibold text-gray-900 mb-2 group-hover:text-gray-600 transition-colors leading-snug">
                          {article.title}
                        </h3>
        ...
        <div className="container">
          <motion.div className="max-w-2xl mx-auto text-center" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}>
            ...
            <p className="text-gray-400 mb-8 max-w-lg mx-auto">
              Rejoignez plus de 2 800 professionnels qui reçoivent nos stratégies chaque semaine.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                type="email"
                placeholder="votre@email.com"
                className="flex-1 px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-white/30 focus:outline-none focus:border-white/40 text-[14px]"
              />
              <button className="px-6 py-3 bg-white text-gray-900 font-medium rounded-lg hover:bg-gray-100 transition-colors text-[14px] whitespace-nowrap">
                S'abonner
              </button>
            </div>
