/*
 * Design: Notion/Tally style — minimal pricing, clean cards, black accents
 */
...
const plans = [
  {
    ...
    popular: false,
    features: [
      { text: "3 comptes sociaux", included: true },
      { text: "30 publications/mois", included: true },
      { text: "Calendrier visuel", included: true },
      { text: "Prévisualisation", included: true },
      { text: "1 utilisateur", included: true },
      { text: "Analyses basiques", included: true },
      { text: "IA intégrée", included: false },
  ...
  {
    name: "Pro",
    desc: "Pour les créateurs",
    priceMonthly: 15,
    priceYearly: 12,
    popular: true,
    features: [
      { text: "10 comptes sociaux", included: true },
      { text: "Publications illimitées", included: true },
      { text: "Calendrier visuel", included: true },
      { text: "Prévisualisation", included: true },
      { text: "3 utilisateurs", included: true },
      { text: "Analyses avancées", included: true },
      { text: "IA intégrée", included: true },
      { text: "Recyclage de contenu", included: true },
      { text: "Rapports PDF", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Rapports clients PDF", included: true },
      { text: "Support dédié + API", included: true },
    ],
...
export default function Pricing() {
  ...
  useEffect(() => {
    document.title = "Prix — Calenji | Plans et Tarifs";
  }, []);
      ...
      <section className="pt-20 pb-16 md:pt-28 md:pb-20">
        <div className="container">
          <motion.div className="max-w-3xl mx-auto text-center" initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <motion.p variants={fadeUp} custom={2} className="text-lg text-gray-500 max-w-xl mx-auto mb-8">
              Pas de surprise. Pas de frais cachés. Choisissez le plan qui correspond à vos besoins.
            </motion.p>
            <motion.div variants={fadeUp} custom={3} className="flex items-center justify-center gap-3">
              ...
              <span className={`text-[14px] ${yearly ? "text-gray-900 font-medium" : "text-gray-400"}`}>
                Annuel <span className="text-green-600 text-[12px] font-medium">-20%</span>
              </span>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {plans.map((plan, i) => (
              <motion.div key={plan.name} initial="hidden" animate="visible" variants={fadeUp} custom={i}
                ...
                <div className="mb-6">
                  <span className="text-4xl font-extrabold text-gray-900">{yearly ? plan.priceYearly : plan.priceMonthly}€</span>
                ...
                <Link href="/contact" className={`block text-center py-2.5 rounded-lg text-[14px] font-medium transition-colors ${plan.popular ? "bg-gray-900 text-white hover:bg-gray-800" : "border border-gray-200 text-gray-700 hover:bg-gray-50"}`}>
                  {plan.cta}
                </Link>
              </motion.div>
            ))}
