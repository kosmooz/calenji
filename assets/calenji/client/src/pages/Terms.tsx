/*
 * Design: Notion/Tally style — minimal legal page
 */
...
export default function Terms() {
  useEffect(() => {
    document.title = "Conditions Générales d'Utilisation — Calenji";
  }, []);
      ...
      <section className="pt-20 pb-24 md:pt-28 md:pb-32">
        <div className="container">
          <motion.div className="max-w-2xl mx-auto" initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <motion.h1 variants={fadeUp} custom={1} className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-4">
              Conditions Générales d'Utilisation
            </motion.h1>
            <motion.p variants={fadeUp} custom={2} className="text-[14px] text-gray-400 mb-12">
            ...
            <div className="space-y-10 text-[15px] text-gray-500 leading-[1.8]">
              ...
              <div>
                ...
                <p>Calenji est fourni "en l'état". Notre responsabilité est limitée au montant des frais d'abonnement payés au cours des 12 derniers mois. Nous ne sommes pas responsables des dommages indirects.</p>
              </div>
